...
public class ExcelGenerateConfigurationCmd {
	...
	/**
	 * Permet de se procurer le type de label specific choisis
	 * Vide si aucun (generation classique)
	 ...
	 * @param haveToGenerateReferenceText vrai si on doit définir les textes de références
	 */

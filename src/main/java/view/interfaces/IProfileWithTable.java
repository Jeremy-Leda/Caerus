...
public interface IProfileWithTable extends IRefreshPanel, IAccessPanel {
    ...
    /**
     * Permet de se procurer les valeurs d'une table
     * @param id identifiant de la table
     * @return la liste des valeurs
     */
    Set<String> getValues(Integer id);

    /**
     * Permet de configurer la sauvegarde des modifications
     * @param consumer consumer pour la sauvegarde
     */
    void setSaveProfileConsumer(Consumer<?> consumer);
